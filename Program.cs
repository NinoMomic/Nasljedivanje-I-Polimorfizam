...
namespace NaslPoli
{
    ...
    class IceCream : Dessert
    {
        ...
        public override string ToString()
        {
            return "Ime torte je " + this.Name + " teži: " + this.Weight + " i ima " + this.Calories + " kalorija." + " okus je " + flavour + " boja kolaca je " + color;
        }
    ...
    internal class Program
    {
        ...
        {
            Dessert dessert = new Dessert("AAAA", 90.1, 600);
            Cake cake = new Cake("ABC", 70.8, 65, true, "rođendanska");
